...
당근은 "로컬의 모든 것을 연결해, 동네의 숨은 가치를 깨우는" 하이퍼로컬 플랫폼이에요. 맛ZIP은 이 동네 연결의 가치를 외국인 관광객에게까지 확장할 수 있는 프로젝트에요. 동네 인증을 거친 진짜 이웃들이 추천하는 맛집 데이터, 동네 가게 사장님들이 직접 운영하는 비즈프로필의 최신 정보 등 — 향후 당근의 로컬 신뢰 네트워크와 연계하면, 외국인도 현지인처럼 동네 맛집을 경험할 수 있어요.
